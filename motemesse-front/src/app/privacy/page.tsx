            ...
            <div className="space-y-6 text-gray-700">
              ...
              <section>
                ...
                <p className="leading-relaxed">
                  ...
                  なお、本サービスにおいて収集する「ニックネーム」「年齢」「趣味」「会話履歴」「スクリーンショット内の情報」等は、それ単体では特定の個人を識別できない場合が多いですが、当サービスではこれらも利用者のプライバシーに関わる重要な情報として、厳重に管理いたします。
                </p>
              </section>
              ...
              <section>
                ...
                <ul className="list-disc list-inside space-y-2 ml-4">
                  ...
                  <li>利用者がアップロードした画像データ（スクリーンショット等）</li>
              ...
              <section>
                ...
                <div className="mb-4">
                  <h3 className="text-lg font-medium text-gray-800 mb-2">1. OpenAI社および画像解析サービス提供者への情報提供</h3>
                  <p className="leading-relaxed">
                    本サービスでは、メッセージ生成および画像解析のため、利用者が入力した情報（テキスト、画像データ）をOpenAI社またはGoogle Cloud Vision API等の外部APIに送信します。<br/>
                    送信される情報には、原則として個人を特定できる情報は含まれませんが、利用者は自身の責任において、画像内の顔写真や個人特定情報をトリミングまたはマスキング処理した上でアップロードするものとします。<br/>
                    なお、当サービスは外部APIを利用しており、原則として入力データがAIモデル学習に使用されない設定（または方針）に基づき運用していますが、各社の利用規約変更等により取り扱いが変わる可能性があります。
                  </p>
                </div>
              ...
              <section>
                ...
                <ul className="list-disc list-inside space-y-2 ml-4">
                  ...
                  <li>画像データ：テキスト抽出処理が完了次第、サーバーメモリ上から即座に削除され、恒久的なストレージには保存されません（※もし一時保存する場合は「一定期間経過後に自動削除されます」等に変更）。</li>
              ...
              <section>
                ...
                <p className="leading-relaxed">
                  ...
                  なお、当サービスは、利用者が利用規約に違反して入力した個人情報（本名、連絡先、顔写真等）について、その検知や削除を行う義務を負うものではありませんが、発見した場合には予告なく削除する場合があります。
                </p>
              </section>
