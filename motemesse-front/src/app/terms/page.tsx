            ...
            <div className="space-y-6 text-gray-700">
              ...
              <section>
                ...
                <ul className="list-disc list-inside space-y-2 ml-4">
                  ...
                  <li>「画像解析機能」とは、利用者がアップロードした画像（スクリーンショット等）から文字情報を抽出する機能をいいます。</li>
                </ul>
              </section>
                ...
                <ol className="list-decimal list-inside space-y-2 ml-4">
                  <li>本サービスは、以下の機能を提供します。
                    <ul className="list-disc list-inside ml-6 mt-2 space-y-1">
                      ...
                      <li>マッチングアプリの会話画面スクリーンショットからのテキスト抽出（画像解析機能）</li>
              ...
              <section>
                ...
                <ul className="list-disc list-inside space-y-2 ml-4">
                  ...
                  <li>反社会的勢力でないこと</li>
                  <li>本サービスに入力する情報（会話履歴、アップロードする画像等）から、個人を特定できる情報（本名、住所、電話番号、ID、顔写真等）をあらかじめ削除、トリミング、または伏字にするなどして、個人情報の保護に配慮すること</li>
                </ul>
              </section>
              ...
              <section>
                ...
                <ol className="list-decimal list-inside space-y-2 ml-4">
                  ...
                  <li>本サービスの入力フォーム（プロフィール欄、会話履歴入力欄、画像アップロード機能等を含む）に対し、利用者自身または第三者（マッチング相手を含む）の個人を特定できる情報（本名、詳細な住所、電話番号、メールアドレス、LINE ID等のSNSアカウント、勤務先、学校名、顔写真等）を入力または送信する行為<br/>
                ...
                <ol className="list-decimal list-inside space-y-2 ml-4">
                  <li>当局は、以下の事項について一切の責任を負いません。
                    <ul className="list-disc list-inside ml-6 mt-2 space-y-1">
                      ...
                      <li>画像解析機能によるテキスト抽出の正確性、完全性（文字認識の誤り等を含む）</li>
                      <li>利用者がマッチングアプリの利用規約に違反することにより生じる損害</li>
                      <li>利用者とマッチング相手との間で生じるトラブル</li>
                      <li>利用者が本規約第6条第4項に違反し、本サービス内に個人情報（顔写真等を含む）を入力・送信したことにより発生したプライバシー侵害、情報漏洩、その他のトラブル</li>
              ...
              <section>
                ...
                <ol className="list-decimal list-inside space-y-2 ml-4">
                  ...
                  <li>利用者は、当局が本サービスの提供、保守、改善、および学術研究等の目的の範囲内で、利用者が入力した情報（アップロードされた画像を含む）および生成されたテキストデータを、個人を特定できない形式において無償かつ無期限に使用（複製、複写、改変、統計データ化等）することを許諾するものとします。</li>
